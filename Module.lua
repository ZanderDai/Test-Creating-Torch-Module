local Module = torch.class('zz.Module')
...
function Module:type(type)
   ...
   for key,param in pairs(self) do
      self[key] = zz.utils.recursiveType(param, type)
   end
   return self
end
...
function Module:getParameters()
   ...
   local flatParameters = zz.Module.flatten(parameters)
   collectgarbage()
   local flatGradParameters = zz.Module.flatten(gradParameters)
   collectgarbage()
